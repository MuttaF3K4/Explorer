...
class UI:
    def __init__(self):
        ...
        self.energy_bar_rect = pygame.Rect(10,694,ENERGY_BAR_WIDTH,BAR_HEIGHT) # y = +24 from health bar
    ...
    def weapon_overlay(self,weapon_index, has_switched):
        bg_rect = self.selection_box(1115, 20, has_switched)
    ...
    def magic_overlay(self,magic_index, has_switched):
        bg_rect = self.selection_box(1180, 10, has_switched)
